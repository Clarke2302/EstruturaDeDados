...
import java.util.Scanner;
    public class Main { //funções ordenar
        ...
        public static void imprimeMenu(){ //Imprime o menu e Voltar ao menu
            ...
            System.out.println("Mostrar todos os valores armazenados, digite: 11");
            System.out.println("Quantas buscas foram realizadas, digite: 12");
...
//-------------------------4------------------------------------
    ...
    //-----------11--------------------
    public static void menuOnze(int []vetor){
    ...
    //--------------12--------------
    public static void menuDoze (int[]arr) {
    ...
    public static void main(String[] args) {
        ...
        while(tecla!=0){
            ...
            while(i<10){
                ...
                if(tecla==11){//Mostrar valores armazenados
                    menuOnze(arr);
                }

                if(tecla==12){//Consultar quantas buscas tiveram
                    menuDoze(arr);
                }
